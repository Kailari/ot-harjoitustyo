...
import toilari.otlite.rendering.lwjgl.AnimatedSprite;
...
public class CharacterRenderer implements IRenderer<AbstractCharacter> {
    ...
    @Override
    public void draw(@NonNull Camera camera, @NonNull AbstractCharacter character) {
        glEnable(GL_BLEND);
    ...
    @Override
    public void postDraw(@NonNull Camera camera, @NonNull AbstractCharacter character) {
